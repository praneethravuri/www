...
export function FloatingToggle() {
    ...
    return (
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[100]">
            <div className="bg-background/80 backdrop-blur-md border border-neutral-800 shadow-2xl p-1 rounded-none">
                <Tabs value={mode} onValueChange={(v) => setMode(v as "human" | "machine")}>
                    <TabsList className="bg-transparent border-0 h-auto p-0 gap-0 rounded-none">
                        <TabsTrigger
                            value="human"
                            className="rounded-none px-4 py-2 text-sm data-[state=active]:bg-primary data-[state=active]:text-brand border-0 hover:bg-muted/50 gap-2 transition-all duration-300"
                        >
